...
chmod 1777 /dev/shm
apk update
echo openssh openbox xfe qterminal rofi mousepad 7zip unzip curl zsh git python3 perl gawk xz sudo vim xterm gcompat dbus dbus-x11 ibus ibus-hangul firefox font-noto-cjk font-noto-emoji sof-firmware alsa-ucm-conf xrandr tigervnc pulseaudio pavucontrol-qt tor lyrebird | tr ' ' \\n > list
