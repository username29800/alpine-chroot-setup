#!/bin/sh
# prerequisites: root previlege, sudo, git, xorg, vncserver(tigervnc/tightvnc), zsh, sh, coreutils, sed, grep, vim, firefox, mate-desktop, dconf, gsettings, unzip, rootfs (or) working linux environment
user=$1
mkdir /build
cd /build
